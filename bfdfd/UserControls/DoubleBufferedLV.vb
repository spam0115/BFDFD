...
Public Class DoubleBufferedLV
    ...
    Private m_PreventSort As Boolean
    ...
    Public Sub SortByColumn(ByVal Column As Integer)
        ...
        ' Create a comparer.
        Me.ListViewItemSorter = New ListViewComparer(Column, sort_order)
