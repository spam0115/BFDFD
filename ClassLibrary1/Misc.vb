...
Public Class Misc
        ...
        Public Shared Sub SetToolTip(ByVal ctrl As Control, ByVal text As String)
            Dim tToolTip As ToolTip = New ToolTip
            With tToolTip
        ...
        Public Shared Sub CloseWithEchapKey(ByRef frm As Form)
            frm.KeyPreview = True
            Dim oo As New KeyEventHandler(AddressOf handlerCloseForm_)
        ...
        Public Shared Function ShowMsg(ByVal Title As String,
        ...
        Private Shared Sub handlerCloseForm_(ByVal sender As Object, ByVal e As KeyEventArgs)
            If e.KeyCode = Keys.Escape Then
                Try
                    Dim _tmp As Form = DirectCast(sender, Form)
