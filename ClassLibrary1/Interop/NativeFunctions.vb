...
#Region "Declarations used for files"
        ...
        Public Shared Function GetShortPathName(ByVal longPath As String,
              <MarshalAs(UnmanagedType.LPTStr)> ByVal ShortPath As StringBuilder,
        ...
        Public Shared Function CreateFile(ByVal lpFileName As String,
                                ByVal dwDesiredAccess As NativeEnums.EFileAccess,
                                ByVal dwShareMode As NativeEnums.EFileShare,
                                ByVal lpSecurityAttributes As IntPtr,
                                ByVal dwCreationDisposition As NativeEnums.ECreationDisposition,
                                ByVal dwFlagsAndAttributes As NativeEnums.EFileAttributes,
        ...
        Public Shared Function ShellExecuteEx(ByRef lpExecInfo As NativeStructs.ShellExecuteInfo) As Boolean
        End Function
        ...
        Public Shared Function SetFilePointerEx(ByVal hFile As IntPtr,
                                                ByVal liDistanceToMove As Long,
                                                ByRef lpNewFilePointer As Long,
                                                ByVal dwMoveMethod As NativeEnums.EMoveMethod) As Boolean
        End Function
        ...
        Public Shared Function SHFileOperation(ByRef lpFileOp As NativeStructs.SHFILEOPSTRUCT) As Integer
        End Function

        <DllImport("shell32.dll")>
        Public Shared Sub SHChangeNotify(
                    ByVal wEventID As NativeEnums.HChangeNotifyEventID,
                    ByVal uFlags As NativeEnums.HChangeNotifyFlags,
