...
#Region "Declarations used for files"
        ...
        Public Structure ShellExecuteInfo
            ...
            Public fMask As NativeEnums.ShellExecuteInfoMask
            Public hwnd As IntPtr
            <MarshalAs(UnmanagedType.LPTStr)> Public lpVerb As String
            <MarshalAs(UnmanagedType.LPTStr)> Public lpFile As String
            <MarshalAs(UnmanagedType.LPTStr)> Public lpParameters As String
            <MarshalAs(UnmanagedType.LPTStr)> Public lpDirectory As String
            Dim nShow As NativeEnums.ShowWindowType
        ...
        Public Structure SHFILEOPSTRUCT
            Public hwnd As IntPtr
            Public wFunc As NativeEnums.FO_Func
            Public pFrom As IntPtr
            Public pTo As IntPtr
            Public fFlags As NativeEnums.FILEOP_FLAGS_ENUM
